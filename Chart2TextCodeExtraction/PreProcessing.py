##this file contains the complete preprocessing step of the original Chart2Text
...
for i in range(len(dataFiles)):
    ...
    captionPath = './dataset_barchart/captions/' + str(captionFiles[i]) + '.txt'
    titlePath = './dataset_barchart/titles/' + str(titleFiles[i]) + '.txt'
    ...
    while m < len(captionTokens):
        ...
        if m < len(captionTokens) - 1:
            if captionTokens[m] == captionTokens[m + 1]:
                # print('popping 1 ', captionTokens[m+1])
    ...
    # else:
        # print(i, captionMatchCount, dataMatchCount, sum(xDataLabels),  sum(yDataLabels) )


if (isSingleChart):
    print(summaryArr)
else:
    with open('./dataset_barchart/PreProcesssedExactMatchingSummary.txt', mode='wt', encoding='utf8') as myfile1:
    ...
    with open('./dataset_barchart/OriginalSummary.txt', mode='wt', encoding='utf8') as myfile1:
        myfile1.writelines("%s" % line for line in oldSummaryArr)


    with open('./dataset_barchart/PreProcesssedExactMatchingSummaryLabel.txt', mode='wt', encoding='utf8') as myfile7:
