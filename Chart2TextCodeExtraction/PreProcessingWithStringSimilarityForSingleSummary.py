...
dataPath = './Parsers/IzaDataToChartText/dataset/data/' + str(chartno) + '.csv'
captionPath = './Parsers/IzaDataToChartText/dataset/captions/' + str(chartno) + '.txt'
titlePath = './Parsers/IzaDataToChartText/dataset/titles/' + str(chartno) + '.txt'
