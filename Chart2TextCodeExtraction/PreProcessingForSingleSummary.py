...
dataPath = './dataset_barchart/data/' + str(chartno) + '.csv'
captionPath = './dataset_barchart/captions/' + str(chartno) + '.txt'
titlePath = './dataset_barchart/titles/' + str(chartno) + '.txt'
...
if captionMatchCount >= 1 and dataMatchCount >= 1:
    ...
    print(captionMatchCount, dataMatchCount, sum(xDataLabels),  sum(yDataLabels) )
